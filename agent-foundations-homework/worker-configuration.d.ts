/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 714bc0f6da84c345f2c458ecb7d8fb5e)
// Runtime types generated with workerd@1.20260828.1 2026-05-14 nodejs_compat
interface __BaseEnv_Env {
	ROOM_TOKEN: string;
	VoteRoomAgent: DurableObjectNamespace<import("./worker/index").VoteRoomAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "VoteRoomAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ROOM_TOKEN">> {}
}
